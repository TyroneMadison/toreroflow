...
In the installed app (no rebuild needed; nothing in the desktop changed), Analytics for Caleb, Videos area: the Instagram population should be around 452 rather than 136, tier boards hold all-time rankings, the 30/60/90/All chips filter the non-board sections, platform tabs scope the boards.
